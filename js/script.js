...
/*index.html*/
// 広告要素が消された場合に1秒毎に復活させる
// 6秒後に広告を表示する関数
function showAd() {
  const adHtml = `
    <div id="fixed-ad" style="
      position: fixed;
      top: 50%;
      left: 50%;
    ...
    ">
    <p>ホームページを移設しました。
    <br>以下のURLをクリックをしてアクセスをお願いします。
    <br>青丹祭2025公式ホームページ
    <br><a href="https://yoshidasouichi987.github.io/SchoolWeb/">https://yoshidasouichi987.github.io/SchoolWeb/</a>
  </p>
    </div>
  `;
...
// 広告が消された場合に復活させる監視処理
setInterval(() => {
  if (!document.getElementById('fixed-ad')) {
    showAd();
  }
}, 6000);
...
const festivalDate = new Date('2025-09-05T08:50:00');
...
function updateCountdown() {
  ...
  if (diff <= 0) {
    ...
    document.getElementById('message').textContent = "青丹祭が始まりました！";
    clearInterval(timer);
    return;
  }
...
$(function(){
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function createFeather(x, y) {
        ...
        feather.src = 'img/other/feather2.png'; // 羽の画像パス
